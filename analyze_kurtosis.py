...
def main():
    ...
    parser.add_argument("--coconut_path", type=str, default="/mnt/bn/rai/zout/coconut/checkpoints/gsm-coconut/gsm-residual-probe-update_III/checkpoint_13", help="Path to Coconut trained checkpoint")
